...
> **HISTORICAL (updated 2026-04-28).** Publish hold lifted 2026-04-27; this design is now implemented and shipped as `frame-check-mcp` `0.8.0`, `0.8.1`, `0.8.2` on PyPI per `CHANGELOG.md`. The `0.7.1rc1` placeholder release in §7.3 was retired 2026-04-23 in favor of V4.2-first launch discipline (see `MCP_SERVER.md` "Release arc"). Read this document as the design rationale that produced the shipping wheel; current operational state lives in `CHANGELOG.md`, `MCP_SERVER.md`, `RELEASE_PREP_v1.md` (post-lift checklist), and `scripts/lift_dry_run.py` (10-step gate).

**Status:** design v1, 2026-04-23. Implementation shipped 2026-04-27 (release 0.8.0); see `CHANGELOG.md` for the lift sequence and the post-lift defects (0.8.1 Project-URL repair, 0.8.2 in-content link rewriter) closed in subsequent releases.
