...
- **claude** is the counterfactual outlier in **all 2 of 2** comparable peer groups it appears in. Fired patterns in claude's outlier documents: FVS-007 (2 of 2), FVS-001 (1 of 2). Named library entries for counterfactual (full canon space): FVS-001, FVS-007, FVS-009, FVS-012, FVS-014.
...
Lucic, L. (2026). Frame Check decision-readiness aggregate findings, corpus revision `9d32f987c2b8`, computed 2026-04-20. (production paused)
