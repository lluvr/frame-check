...
- **Coverage**: [FVS-001 Frame Amplification](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-001_frame_amplification.md), [FVS-008 Growth Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-008_growth_frame.md), [FVS-009 Risk Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-009_risk_frame.md), [FVS-010 Completeness Illusion](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-010_completeness_illusion.md), [FVS-011 Stakeholder Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-011_stakeholder_frame.md), [FVS-014 Temporal Anchoring](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-014_temporal_anchoring.md), [FVS-015 Efficiency Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-015_efficiency_frame.md), [FVS-017 False Balance](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-017_false_balance.md)
- **Calibration**: [FVS-012 Uncertainty Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-012_uncertainty_frame.md), [FVS-017 False Balance](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-017_false_balance.md)
- **Evidence**: [FVS-016 Authority by Citation](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-016_authority_by_citation.md)
- **Robustness**: [FVS-016 Authority by Citation](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-016_authority_by_citation.md)
- **Counterfactual**: [FVS-001 Frame Amplification](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-001_frame_amplification.md), [FVS-007 Failure Framing](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-007_failure_framing.md), [FVS-009 Risk Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-009_risk_frame.md), [FVS-012 Uncertainty Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-012_uncertainty_frame.md), [FVS-014 Temporal Anchoring](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-014_temporal_anchoring.md)
...
- **claude** is the counterfactual outlier in **all 2 of 2** comparable peer groups it appears in. Fired patterns in claude's outlier documents: [FVS-007 Failure Framing](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-007_failure_framing.md) (2 of 2), [FVS-001 Frame Amplification](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-001_frame_amplification.md) (1 of 2). Named library entries for counterfactual (full canon space): [FVS-001 Frame Amplification](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-001_frame_amplification.md), [FVS-007 Failure Framing](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-007_failure_framing.md), [FVS-009 Risk Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-009_risk_frame.md), [FVS-012 Uncertainty Frame](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-012_uncertainty_frame.md), [FVS-014 Temporal Anchoring](https://github.com/lluvr/frame-check-mcp/blob/master/data/frame_library/FVS-014_temporal_anchoring.md). See claude's corpus entries: Claude on whether to retire on Bitcoin (life-decision question), Claude on whether to take a startup offer (life-decision question).
